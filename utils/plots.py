...
# changes made here
def plot_one_box(x, img, color=None, label=None, line_thickness=3,is_near=False):
    # Plots one bounding box on image img
    tl = line_thickness or round(0.002 * (img.shape[0] + img.shape[1]) / 2) + 1  # line/font thickness
    color = color or [random.randint(0, 255) for _ in range(3)]
    # c1 c2 are top right and bottom left co-ordinates
    ...
    if(is_near == False)return [-1,-1,-1,-1];
